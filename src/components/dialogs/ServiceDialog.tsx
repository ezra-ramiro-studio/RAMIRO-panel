...
export function ServiceDialog({ trigger }: Props) {
  ...
  return (
    <>
      ...
      <Dialog open={open} onClose={() => setOpen(false)} title="Nuevo servicio">
        <form action={onSubmit}>
          ...
          <FormGrid>
            <div>
              ...
              <Select id="type" name="type" defaultValue="proyecto">
            ...
            <div>
              ...
              <Input id="estimated_delivery_days" name="estimated_delivery_days" type="number" />
            </div>
          </FormGrid>
          <FormGrid>
            <div>
              <Label htmlFor="price_ars">Precio ARS</Label>
              <Input id="price_ars" name="price_ars" type="number" step="0.01" defaultValue="0" />
            </div>
            <div>
              <Label htmlFor="price_usd">Precio USD</Label>
              <Input id="price_usd" name="price_usd" type="number" step="0.01" defaultValue="0" />
            </div>
          </FormGrid>
